...
class EvolutionalAgent(object):
    ...
    def initialize(self, state, weights=()):
        ...
        model.add(K.layers.Conv2D(
            3, kernel_size=5, strides=3, input_shape=state.shape,
...
class EvolutionalTrainer(object):
    ...
    def update(self, agent_results):
        ...
        for i, w in enumerate(self.weights):
            ...
            # print("noise_at_i.shape: {}".format(noise_at_i.shape))
            # print("normalized_rs.shape: {}".format(normalized_rs.shape))
